...
@section('title', config('app.name') . ' || Employee Details')
@section('content')
    <div class="content">
                                    ...
                                    <div class="accordion-body mt-2">
                                        <form method="POST" id="AboutForm">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea name="about" rows="5" class="form-control" placeholder="Write about employee...">{{ optional($employee->profile)->about }}</textarea>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3 mb-3">
                                                        ...
                                                        <input type="date" name="confirmation_date"
                                                            value="{{ old('confirmation_date', optional($employee->profile)->confirmation_date ? optional($employee->profile)->confirmation_date->format('Y-m-d') : '') }}"
                                                            class="form-control">
                                                    ...
                                                    <div class="col-md-3 mb-3">
                                                        ...
                                                        <input type="date" name="planned_join_date"
                                                            value="{{ old('planned_join_date', $employee->profile?->planned_join_date?->format('Y-m-d')) }}"
                                                            class="form-control">
                                                    ...
                                                    <div class="col-md-3 mb-3">
                                                        ...
                                                        <input type="date" name="joined_on"
                                                            value="{{ old('joined_on', $employee->profile?->joined_on?->format('Y-m-d')) }}"
                                                            class="form-control">
                                                    ...
                                                    <div class="col-md-3 mb-3">
                                                        ...
                                                        <input type="number" name="probation_period"
                                                            value="{{ old('probation_period', $employee->profile?->probation_period) }}"
                                                            class="form-control">
                                                    ...
                                                    <div class="col-md-3 mb-3">
                                                        ...
                                                        <input type="number" name="notice_period"
                                                            value="{{ old('notice_period', $employee->profile?->notice_period) }}"
                                                            class="form-control">
                                                    ...
                                                    <div class="col-md-3 mb-3">
                                                        ...
                                                        <input type="number" step="0.1" name="previous_experience"
                                                            value="{{ old('previous_experience', $employee->profile?->previous_experience) }}"
                                                            class="form-control">
                                                    ...
                                                    <div class="col-md-3 mb-3">
                                                        ...
                                                        <input type="number" step="0.1" name="total_experience"
                                                            value="{{ old('total_experience', $employee->profile?->total_experience) }}"
                                                            class="form-control">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input type="text" name="bank_name"
                                                        value="{{ old('bank_name', $employee->profile?->bank_name) }}"
                                                        class="form-control">
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input type="text" name="ifsc_code"
                                                        value="{{ old('ifsc_code', $employee->profile?->ifsc_code) }}"
                                                        class="form-control">
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input type="text" name="branch"
                                                        value="{{ old('branch', $employee->profile?->branch) }}"
                                                        class="form-control">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="account_holder_name"
                                                        value="{{ old('account_holder_name', $employee->profile?->account_holder_name) }}"
                                                        class="form-control">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input type="text" name="uan_number"
                                                        value="{{ old('uan_number', $employee->profile?->uan_number) }}"
                                                        class="form-control">
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input type="text" name="pf_account_number"
                                                        value="{{ old('pf_account_number', $employee->profile?->pf_account_number) }}"
                                                        class="form-control">
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <select name="pf_applicable" class="form-control">
                                                        ...
                                                        <option value="Yes"
                                                            {{ old('pf_applicable', $employee->profile?->pf_applicable) == 'Yes' ? 'selected' : '' }}>
                                                            Yes</option>
                                                        <option value="No"
                                                            {{ old('pf_applicable', $employee->profile?->pf_applicable) == 'No' ? 'selected' : '' }}>
                                                            No</option>
                                                    </select>
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input type="date" name="pf_join_date"
                                                        value="{{ old('pf_join_date', $employee->profile?->pf_join_date?->format('Y-m-d')) }}"
                                                        class="form-control">
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input type="date" name="pf_exit_date"
                                                        value="{{ old('pf_exit_date', $employee->profile?->pf_exit_date?->format('Y-m-d')) }}"
                                                        class="form-control">
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input type="text" name="pf_contribution_type"
                                                        value="{{ old('pf_contribution_type', $employee->profile?->pf_contribution_type ?? 'Full Wages') }}"
                                                        class="form-control">
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input type="text" name="pf_name"
                                                        value="{{ old('pf_name', $employee->profile?->pf_name) }}"
                                                        class="form-control">
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input type="date" name="pf_dob"
                                                        value="{{ old('pf_dob', $employee->profile?->pf_dob?->format('Y-m-d')) }}"
                                                        class="form-control">
                                                    <span class="text-danger error-pf_dob"></span>
                                                </div>
                                                <div class="col-md-12 mb-3">
                                                    <label>Previous PF Details</label>
                                                    <textarea name="pf_previous_details" class="form-control">{{ old('pf_previous_details', $employee->profile?->pf_previous_details) }}</textarea>
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input type="text" name="esic_number"
                                                        value="{{ old('esic_number', $employee->profile?->esic_number) }}"
                                                        class="form-control">
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <select name="esic_applicable" class="form-control">
                                                        <option value="">Select</option>
                                                        <option value="Yes"
                                                            {{ old('esic_applicable', $employee->profile?->esic_applicable) == 'Yes' ? 'selected' : '' }}>
                                                            Yes</option>
                                                        <option value="No"
                                                            {{ old('esic_applicable', $employee->profile?->esic_applicable) == 'No' ? 'selected' : '' }}>
                                                            No</option>
                                                    </select>
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input type="date" name="esic_join_date"
                                                        value="{{ old('esic_join_date', $employee->profile?->esic_join_date?->format('Y-m-d')) }}"
                                                        class="form-control">
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input type="date" name="esic_exit_date"
                                                        value="{{ old('esic_exit_date', $employee->profile?->esic_exit_date?->format('Y-m-d')) }}"
                                                        class="form-control">
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input type="text" name="esic_name"
                                                        value="{{ old('esic_name', $employee->profile?->esic_name) }}"
                                                        class="form-control">
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input type="date" name="esic_dob"
                                                        value="{{ old('esic_dob', $employee->profile?->esic_dob?->format('Y-m-d')) }}"
                                                        class="form-control">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <button class="btn btn-sm btn-warning edit-btn"
                                                                            data-id="{{ $educ->id }}"
                                                                            data-qualification="{{ $educ->qualification }}"
                                                                            data-qualification_area="{{ $educ->qualification_area }}"
                                                                            data-course="{{ $educ->course }}"
                                                                            data-institution_name="{{ $educ->institution_name }}"
                                                                            data-grade="{{ $educ->grade }}"
                                                                            data-remark="{{ $educ->remark }}"
                                                                            data-start_date="{{ $educ->start_date }}"
                                                                            data-end_date="{{ $educ->end_date }}"
                                                                            data-document="{{ $educ->document }}">
                                                                            Edit
                                                                        </button>
                                                                    ...
                                                                    <td>{{ $educ->qualification }}</td>
                                                                    <td>{{ $educ->qualification_area ?? '-' }}</td>
                                                                    <td>{{ $educ->course ?? '-' }}</td>
                                                                    <td>{{ $educ->institution_name }}</td>
                                                                    <td>{{ $educ->grade ?? '-' }}</td>
                                                                    <td>{{ $educ->remark ?? '-' }}</td>
                                                                    <td>{{ \Carbon\Carbon::parse($educ->start_date)->format('d-m-Y') }}
                                                                    </td>
                                                                    <td>{{ \Carbon\Carbon::parse($educ->end_date)->format('d-m-Y') }}
                                                                    </td>
                                                                    <td>
                                                                        @if ($educ->document)
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <button class="btn btn-sm btn-warning edit-exp-btn"
                                                                            ...
                                                                            data-is_present="{{ $exp->is_present }}">
                                                                            Edit
                                                                        </button>
                                                                        <button
                                                                    ...
                                                                    <td>{{ \Carbon\Carbon::parse($exp->start_date)->format('d-m-Y') }}
                                                                    </td>
                                                                    <td>
                                                                        {{ $exp->is_present ? 'Present' : \Carbon\Carbon::parse($exp->end_date)->format('d-m-Y') }}
                                                                    </td>
                                                                    <td>{{ $exp->is_present ? 'Yes' : 'No' }}</td>
                                                                </tr>
                                                            @endforeach
                                                        @else
                                                            <tr>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="present_city"
                                                        value="{{ old('present_city', $employee->profile?->present_city) }}"
                                                        class="form-control">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="present_state"
                                                        value="{{ old('present_state', $employee->profile?->present_state) }}"
                                                        class="form-control">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="present_country"
                                                        value="{{ old('present_country', $employee->profile?->present_country) }}"
                                                        class="form-control">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="number" name="present_pincode"
                                                        value="{{ old('present_pincode', $employee->profile?->present_pincode) }}"
                                                        class="form-control">
                                                    <span class="text-danger error-present_pincode"></span>
                                                </div>
                                                <div class="col-md-12 mb-3">
                                                    <label class="form-label">Address</label>
                                                    <textarea name="present_address" class="form-control">{{ old('present_address', $employee->profile?->present_address) }}</textarea>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="permanent_city"
                                                        value="{{ old('permanent_city', $employee->profile?->permanent_city) }}"
                                                        class="form-control">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="permanent_state"
                                                        value="{{ old('permanent_state', $employee->profile?->permanent_state) }}"
                                                        class="form-control">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" name="permanent_country"
                                                        value="{{ old('permanent_country', $employee->profile?->permanent_country) }}"
                                                        class="form-control">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="number" name="permanent_pincode"
                                                        value="{{ old('permanent_pincode', $employee->profile?->permanent_pincode) }}"
                                                        class="form-control">
                                                    <span class="text-danger error-permanent_pincode"></span>
                                                </div>
                                                <div class="col-md-12 mb-3">
                                                    <label class="form-label">Address</label>
                                                    <textarea name="permanent_address" class="form-control">{{ old('permanent_address', $employee->profile?->permanent_address) }}</textarea>
                                    ...
                                    <div class="tab-content" id="myTabContent3">
                                        <div class="tab-pane fade show active" id="assets">
                                            <div id="assetContainer">
                                                ...
                                                @if ($assets->count() > 0 && $assets->hasPages())
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <div class="d-flex align-items-center">
                        ...
                        <span>Employee ID : {{ $employee->employee_code }}</span>
                    </div>
                                ...
                                <div class="d-flex align-items-center flex-wrap row-gap-3 bg-light w-100 rounded p-3 mb-4">
                                    <div class="avatar avatar-xxl rounded-circle border border-dashed me-3">
                                        @if ($employee->profile_image)
                                            <img src="{{ asset($employee->profile_image) }}" class="rounded-circle"
                                                width="100">
                                        @else
                                            <img src="{{ asset('admin/img/person-dummy.jpg') }}" class="rounded-circle"
                                                width="100">
                                        @endif
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" name="passport_no" class="form-control"
                                    value="{{ optional($employee->profile)->passport_no }}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="form-label">Passport Expiry</label>
                                <input type="date" name="passport_expiry" class="form-control"
                                    value="{{ optional($employee->profile)->passport_expiry }}">
                            </div>
                            <div class="col-md-3 mb-3">
                                ...
                                <select name="blood_group_id" class="form-select">
                                    ...
                                    @foreach ($bloodGroups as $group)
                                        <option value="{{ $group->id }}"
                                            {{ optional($employee->profile)->blood_group_id == $group->id ? 'selected' : '' }}>
                                            {{ $group->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" name="father_name" class="form-control"
                                    value="{{ optional($employee->profile)->father_name }}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="form-label">Aadhaar No</label>
                                <input type="text" name="aadhaar_no" maxlength="12" class="form-control"
                                    value="{{ optional($employee->profile)->aadhaar_no }}">
                            </div>
                            <div class="col-md-3 mb-3">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" name="pan_no" maxlength="10" class="form-control"
                                    value="{{ optional($employee->profile)->pan_no }}">
                            </div>
                            <div class="col-md-3 mb-3">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" name="nationality" class="form-control"
                                    value="{{ optional($employee->profile)->nationality }}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="form-label">Religion</label>
                                <input type="text" name="religion" class="form-control"
                                    value="{{ optional($employee->profile)->religion }}">
                            </div>
                            <div class="col-md-3 mb-3">
                                ...
                                <select name="marital_status" id="marital_status" class="form-select">
                                    <option value="">Select</option>
                                    <option value="Yes"
                                        {{ optional($employee->profile)->marital_status == 'Yes' ? 'selected' : '' }}>
                                        Yes
                                    </option>
                                    <option value="No"
                                        {{ optional($employee->profile)->marital_status == 'No' ? 'selected' : '' }}>
                                        No
                                    </option>
                                </select>
                            </div>
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" name="spouse_employment" class="form-control"
                                    value="{{ optional($employee->profile)->spouse_employment }}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="form-label">Children</label>
                                <input type="number" name="children" class="form-control"
                                    value="{{ optional($employee->profile)->children }}">
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="form-label">Differently Abled</label>
                                <select name="differently_abled" class="form-select">
                                    <option value="No"
                                        {{ optional($employee->profile)->differently_abled == 'No' ? 'selected' : '' }}>
                                        No
                                    </option>
                                    <option value="Yes"
                                        {{ optional($employee->profile)->differently_abled == 'Yes' ? 'selected' : '' }}>
                                        Yes</option>
                                </select>
                            </div>
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="email" name="personal_email" class="form-control"
                                    value="{{ optional($employee->profile)->personal_email }}">
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer gap-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="emergency_name_1"
                                    value="{{ optional($employee->profile)->emergency_name_1 }}" class="form-control">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="emergency_relation_1"
                                    value="{{ optional($employee->profile)->emergency_relation_1 }}"
                                    class="form-control">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" name="emergency_phone_1"
                                    value="{{ optional($employee->profile)->emergency_phone_1 }}"
                                    class="form-control">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="emergency_name_2"
                                    value="{{ optional($employee->profile)->emergency_name_2 }}" class="form-control">
                                <span class="text-danger error-emergency_name_2"></span>
                            </div>
                            <div class="col-md-4 mb-3">
                                <label>Relationship</label>
                                <input type="text" name="emergency_relation_2"
                                    value="{{ optional($employee->profile)->emergency_relation_2 }}"
                                    class="form-control">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" name="emergency_phone_2"
                                    value="{{ optional($employee->profile)->emergency_phone_2 }}"
                                    class="form-control">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="qualification_area" id="qualification_area" class="select2">
                                    <option value="">Select</option>
                                    @foreach ($qualificationAreas as $area)
    ...
    <script>
        $("#experienceForm").submit(function(e) {
            ...
            $.ajax({
                url: "{{ route('admin.employee.experience.update') }}",
                type: "POST",
                data: formData,
                processData: false,
                contentType: false,
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#educationForm").submit(function(e) {
                ...
                $.ajax({
                    url: "{{ route('admin.employee.education.update') }}",
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
    ...
    <script>
        $(document).ready(function() {
            $("#EmployeeEditForm").submit(function(e) {
                ...
                $.ajax({
                    url: "{{ route('admin.employees.profile.update') }}",
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
    ...
    <script>
        $(document).ready(function() {
            $("#EditBasicForm").submit(function(e) {
                ...
                $.ajax({
                    url: "{{ route('admin.employee.basic.update') }}",
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#EditPersonalForm").submit(function(e) {
                ...
                $.ajax({
                    url: "{{ route('admin.employees.personal.update') }}",
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#EmergencyForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: "{{ route('admin.employee.emergency.update') }}",
                    type: "POST",
                    data: form.serialize(),
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#AboutForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: "{{ route('admin.employee.about.update') }}",
                    type: "POST",
                    data: form.serialize(),
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#jobInfoForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: "{{ route('admin.employee.job.info.update') }}",
                    type: "POST",
                    data: form.serialize(),
                    success: function(res) {
                        btn.prop('disabled', false);
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#bankForm').on('submit', function(e) {
                ...
                btn.find('.btn-loader').removeClass('d-none');
                $.ajax({
                    url: "{{ route('admin.employee.bank.update') }}",
                    type: "POST",
                    data: form.serialize(),
                    success: function(res) {
                        btn.prop('disabled', false);
    ...
    <script>
        $('#pfEsiForm').on('submit', function(e) {
            ...
            $.ajax({
                url: "{{ route('admin.employee.Pf.Esi.update') }}",
                type: "POST",
                data: formData,
                contentType: false,
                processData: false,
    ...
    <script>
        $('#addressForm').on('submit', function(e) {
            ...
            btn.find('.btn-loader').removeClass('d-none');
            $.ajax({
                url: "{{ route('admin.employee.address.update') }}",
                type: "POST",
                data: formData,
                success: function(res) {
                    btn.prop('disabled', false);
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#manager_designation').on('change', function() {
                ...
                if (id) {
                    $.get("{{ route('admin.get.reporting.manager', ':id') }}".replace(':id', id),
                        function(
                            data) {
